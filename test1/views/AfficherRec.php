...
echo "nb prob : ".$test5."<br>" ; 
echo "probliveraiso : ".$test."<br>" ; 
echo "probproduit : ".$test1."<br>" ; 
echo "probmanquant : ".$test2."<br>" ; 
echo "probsite : ".$test3."<br>" ; 
echo "probautre : ".$test4."<br>" ; 
...
foreach($listeRec as $row){
    ...
    <input type="submit" name="modifier" value="modifierr">
    <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
    </form></td>
    </tr>
    <?PHP
